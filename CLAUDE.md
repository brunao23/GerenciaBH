...
2. **Prompt Caching da Anthropic**: O sistema carregará este `CLAUDE.md` e a estrutura do projeto no topo do contexto. Após as primeiras chamadas, isso será "cacheado", derrubando o custo e latência.
