...
export default function BoasVindasAgentePage() {
        ...
        <div className="max-w-3xl mx-auto space-y-6 p-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <Heart className="h-6 w-6 text-[var(--accent-green)]" />
                    <div>
                ...
                <CardContent className="space-y-5">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm font-medium text-[var(--accent-green)]">{minutesToLabel(cfg.welcomeDelayMinutes)}</span>
                        </div>
