...
export default function EngajamentoAgentePage() {
        ...
        <div className="max-w-3xl mx-auto space-y-6 p-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <Zap className="h-6 w-6 text-[var(--accent-green)]" />
                    <div>
                ...
                <CardContent className="space-y-5">
                    ...
                    <div className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm font-medium text-[var(--accent-green)]">{minutesToLabel(cfg.reengagementDelayMinutes)}</span>
                        </div>
                            ...
                            {presets.map((p) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-md text-xs font-medium border transition-colors ${cfg.reengagementDelayMinutes === p.value
                                        ...
                                        : "border-border text-muted-foreground hover:border-[var(--accent-green)]/50 hover:text-foreground"
                                        }`}
                                >
                                    {p.label}
                                </button>
