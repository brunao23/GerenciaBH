...
export class NativeAgentOrchestratorService {
  ...
  private buildSystemPrompt(
    ...
    const pieces = [
      ...
      "- REGRA DE DATA RELATIVA: use sempre o campo relative_label do slot como referencia. Exemplos de uso correto: 'hoje as 14h', 'amanha as 10h', 'depois de amanha as 9h', 'quinta-feira as 15h' (esta semana), 'proxima terca-feira as 14h' (semana seguinte), 'quarta-feira (29/04) as 10h' (duas ou mais semanas). NUNCA use apenas 'dia 22' sem o dia da semana.",
